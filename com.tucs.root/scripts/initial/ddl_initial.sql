...
create table EN_PARTICIPANT (
  	...
  	DELETED NUMBER(1,0) DEFAULT 0 NOT NULL,
  	CREATED_DATE TIMESTAMP (6) NOT NULL, 
  	CREATED_USER_ID NUMBER(*,0) NOT NULL,
	UPDATED_DATE TIMESTAMP (6), 
...
create table EN_GROUP (
	...
	GROUP_PARENT_ID NUMBER(*,0),
	CONTROL_ID NUMBER(*,0) NOT NULL,
	OWNER_USER_ID NUMBER(*,0) NOT NULL,
	DELETED NUMBER(1,0) DEFAULT 0 NOT NULL,
	CREATED_DATE TIMESTAMP (6) NOT NULL, 
	CREATED_USER_ID NUMBER(*,0) NOT NULL,
	UPDATED_DATE TIMESTAMP (6), 
...
create table EN_TRANSACTION (
  	...
  	CONTROL_MONTHLY_ID NUMBER(*,0) NOT NULL,
  	CONTROL_ID NUMBER(*,0) NOT NULL,
  	CATEGORY_ID NUMBER(*,0) NOT NULL,
  	BASED_TRANSACTION_ID NUMBER(*,0),
  	CREATED_DATE TIMESTAMP (6) NOT NULL, 
  	CREATED_USER_ID NUMBER(*,0) NOT NULL,
	UPDATED_DATE TIMESTAMP (6), 
  	UPDATED_USER_ID NUMBER(*,0),
...
references EN_USER;
/***************************************SEQUENCES*************************************/
create sequence JN_PROFILE_PRIV_SQ;
create sequence EN_USER_SQ;
create sequence EN_PARTICIPANT_SQ;
create sequence EN_GROUP_SQ;
create sequence EN_CONTROL_SQ;
create sequence EN_CONTROL_MONTHLY_SQ;
create sequence EN_TRANSACTION_SQ;
create sequence EN_CATEGORY_SQ;
create sequence RP_CLOSING_MONTHLY_SQ;
create sequence EN_SAVINGS_SQ;